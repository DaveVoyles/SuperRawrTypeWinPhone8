        ...
        EntityPlayer = EntityBaseActor.extend(
        {
            ...
            ******************************************/
            init: function (x, y, settings) {
                ...
                if (!ig.global.wm) {
                    ...
                    this.EnemySpawnerInst = ig.game.spawnEntity(EntityEnemySpawner, this.pos.x + 250, null);
            ...
            ******************************************/
            update: function () {
                ...
                Weapon inventory
                =====================================*/
                if (ig.input.pressed('switch') || this.bSwitchingWeapons) {
                    this.weapon++;
                ...
                if (this.joystick) {
                    ...
                    if (this.joystick.mouseDown && this.bCanUpdateJoystick) {
                        ...
                        if (this.currentMousePoint.y < this.mouseDownPoint.y - 10) {
                            ...
                            this.vel.y = -idleSpeed;
                            this.accel.x = this.speed;
                        } else if (this.currentMousePoint.y > thisssssss.mouseDownPoint.y + 10) {
                            // Moving down
                            this.vel.y = idleSpeed;
                            this.accel.x = this.speed;
                        } else {
