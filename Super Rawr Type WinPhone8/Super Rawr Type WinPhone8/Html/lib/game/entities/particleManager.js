...
ig.module(
    ...
    .defines(function () {
        ...
        EntityParticleManager = ig.Entity.extend({
            _wmIgnore: false,
            _wmDrawBox: true,
            ...
            pool: [],
            maxInstances: 10,
            spawnEntity: EntityBaseParticle,
            particleLifeTime: 1,
            fadetime: 1,
            ...
            createParticle: function () {
                ...
                var instance;
                var instanceName = ig.game.player;

                var x = (Math.random() * instanceName.size.x - 2) + instanceName.pos.x;
                var y = instanceName.pos.y + (instanceName.size.y - 5);
